<%!
from sms_volt.auth import is_allowed
...
<head>
  ...
  <!-- Bootstrap -->
  <link rel="stylesheet" href="${request.static_url('sms_volt:static/bootstrap/css/bootstrap.min.css')}">
  <link rel="stylesheet" href="${request.static_url('sms_volt:static/bootstrap/css/bootstrap-theme.min.css')}">
  
  <!-- Custom CSS -->
  <link rel="stylesheet" href="${request.static_url('sms_volt:static/pyck.css')}" type="text/css" media="screen" charset="utf-8" />
...
<nav class="navbar navbar-inverse" role="navigation">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="${request.route_url('home')}"><img src="${request.static_url('sms_volt:static/pyck-small.png')}"  alt="pyck" /></a>
    </div>
